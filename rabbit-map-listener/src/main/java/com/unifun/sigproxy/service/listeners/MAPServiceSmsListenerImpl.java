...
@Slf4j
public class MAPServiceSmsListenerImpl extends MAPServiceListenerImpl implements MAPServiceSmsListener {
    public MAPServiceSmsListenerImpl(MAPStackImpl mapStack) {
        super(mapStack);
    }

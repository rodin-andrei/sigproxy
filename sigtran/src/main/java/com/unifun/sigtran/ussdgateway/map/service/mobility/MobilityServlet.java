 ...
 *
 */
@WebServlet(name = "MobilityServlet", urlPatterns = {"/mobility"}, displayName = "MobilityServlet", asyncSupported = true)
@Log4j2
public class MobilityServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ExecutionContext.EXECUTOR.submit(() -> {
            try {
                ...
                Channel channel = gateway.channel("map://mobility");
                log.info("Channel " + channel);
                channel.send("map://mobility", new JsonMessage(obj), new HttpLocalContext(context));
            } catch (Exception e) {

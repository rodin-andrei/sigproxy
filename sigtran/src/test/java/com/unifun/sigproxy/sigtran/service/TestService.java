...
//    private final MapChannel mapChannel;
    ...
    private void test(ContextStartedEvent ctxStartEvt) {
        ...
        if (initTestServer)
            initServer();
        ((SigtranServiceImpl) service).init(null);
...
//        }
    ...
    private void initServer() {
        ...
        sigtranStack.setStackName("unifun");
        ...
        sctpServerConfig.setLocalPort(2906);
        ...
        sctpServerAssociationConfig.setRemotePort(2905);

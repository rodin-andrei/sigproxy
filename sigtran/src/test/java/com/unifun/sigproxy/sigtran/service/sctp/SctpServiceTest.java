...
import com.unifun.sigproxy.sigtran.service.sctp.impl.SctpConfigServiceImpl;
...
public class SctpServiceTest {
    ...
    public void getSctpServerConfig_ById_Should_Return_SctpServerConfig() {
        ...
        BDDMockito.given(sctpServerRepository.findById(1L)).willReturn(Optional.of(sctpServerConfig));
    ...
    public void getSctpServerConfig_ById_Should_Return_Null() {
        BDDMockito.given(sctpServerRepository.findById(1L)).willReturn(Optional.empty());
    ...
    public void saveSctpClientAssociationConfig_With_Rigth_Param() {
        ...
        BDDMockito.given(sctpLinkRepository.save(s)).willReturn(s);
    ...
    public void saveSctpClientAssociationConfig_With_Wrong_Param() {
        ...
        sctpConfigService.addSctpClientAssociationConfig(ArgumentMatchers.anyObject());
        Mockito.verify(sctpLinkRepository, Mockito.atLeastOnce()).save(captor.capture());
    ...
    public void removeSctpClientAssociationConfig_With_Right_Id() {
        ...
        Mockito.verify(sctpLinkRepository, Mockito.atLeastOnce()).deleteById(captor.capture());
    ...
    public void getServerLinksBySctpServerId_Should_Return_Set() {
        ...
        Mockito.verify(sctpServerRepository, Mockito.atLeast(2)).findById(1L);
    ...
    public void getClientLinkById_Should_Return_SctpClientAssociationConfig(){
        ...
        BDDMockito.given(sctpLinkRepository.findById(1L)).willReturn(Optional.of(s));
    ...
    public void getSctpServerById_Should_Return_SctpServerConfig(){
        ...
        s.setId(1L);
        log.info("Start emulated sctpServerRepository .......");
        BDDMockito.given(sctpServerRepository.findById(1L)).willReturn(Optional.of(s));
        Optional<SctpServerConfig> sctpServerConfigTest = sctpServerRepository.findById(1L);
        if(sctpServerConfigTest.orElseGet(SctpServerConfig::new).getId() == 1L){
            log.info("sctpServerRepository was emulated successfully");
        } else {
    ...
    public void getServerLinkById_Should_Return_SctpServerAssociationConfig(){
        ...
        BDDMockito.given(remoteSctpLinkRepository.findById(1L)).willReturn(Optional.of(association));
    ...
    public void removeServerLinkById_Should_Return_Void(){
        ...
        s.setId(1L);
        BDDMockito.given(remoteSctpLinkRepository.findById(1L)).willReturn(Optional.of(s));
        Long deletedId = 1L;
        ArgumentCaptor<Long> captor = ArgumentCaptor.forClass(Long.class);
        sctpConfigService.removeSctpServerAssociationConfigById(deletedId);
        Mockito.verify(remoteSctpLinkRepository, Mockito.atLeastOnce()).deleteById(captor.capture());
        Assertions.assertThat(captor.getValue()).isEqualTo(deletedId);
    }
    ...
    public void getSctpServersByStackId_Should_Return_List(){
        ...
        BDDMockito.given(sctpServerRepository.findAll()).willReturn(sctpServerConfigs);
        ...
        Mockito.verify(sctpServerRepository, Mockito.atLeastOnce()).findAll();
    ...
    public void getClientLinksByStackId_Should_Return_Set(){
        ...
        Mockito.verify(sigtranStackRepository, Mockito.atLeastOnce()).findById(1L);
    ...
    public void saveSctpServe_Should_Return_SavedObject(){
        SctpServerConfig sctpServerConfig = new SctpServerConfig();
        sctpServerConfig.setId(1L);
        BDDMockito.given(sctpServerRepository.save(sctpServerConfig)).willReturn(sctpServerConfig);
        ...
        Mockito.verify(sctpServerRepository, Mockito.atLeastOnce()).save(captorSctpServerConf.capture());
    ...
    public void saveServerLink_Should_Return_SavedObject(){
        ...
        BDDMockito.given(remoteSctpLinkRepository.save(sctpServerAssociationConfig)).willReturn(sctpServerAssociationConfig);
        ...
        Mockito.verify(remoteSctpLinkRepository, Mockito.atLeastOnce()).save(captorSctpServerAssociationConfig.capture());
    ...
    public void saveClinetLink_Should_Return_SavedObject(){
        ...
        BDDMockito.given(sctpLinkRepository.save(sctpClientAssociationConfig)).willReturn(sctpClientAssociationConfig);
        ...
        Mockito.verify(sctpLinkRepository, Mockito.atLeastOnce()).save(captorSctpClientAssociationConfig.capture());
